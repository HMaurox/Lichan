...
def json_sesion_bl():
    ...
    with open('blockcahin.json', 'w') as jsonFile:
        json.dump(cadena, jsonFile)
        jsonFile.close()   
...
def comprar_li_adm (numer_L,Id_enti):
    conexion = pymysql.connect(host="localhost",user="root",passwd="12345",database="blockchain")
    cursor = conexion.cursor()
    #obtemos  el ID de la entidad a la que pertenece  el usuario
    SQL="SELECT FK_ID_ENTIDAD FROM usuario WHERE CORREO=%s"
...
def certi_us_adm(id_us):      
    conexion = pymysql.connect(host="localhost",user="root",passwd="12345",database="blockchain")
    cursor = conexion.cursor()
    #consultas#
    SQL= "SELECT CORREO FROM usuario WHERE ID_Usuario = %s"
    cursor.execute(SQL,id_us)
    ...
    os.remove(temporal)    
    print("su correo fue enviado correctamente")
def certi_en_adm(id_en,id_usuario):
    conexion = pymysql.connect(host="localhost",user="root",passwd="12345",database="blockchain")
    cursor = conexion.cursor()
    #consultas#
    SQL="SELECT CORREO FROM usuario WHERE ID_Usuario = %s"
    ...
    os.remove(temporal)    
    print("su correo fue enviado correctamente")
def certi_li_adm(id_usuario,id_licencia):      
    conexion = pymysql.connect(host="localhost",user="root",passwd="12345",database="blockchain")
    cursor = conexion.cursor()
    #consultas#
